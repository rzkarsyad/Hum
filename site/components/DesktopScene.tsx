...
export function DesktopScene() {
  return (
    <div className="relative mx-auto w-full max-w-4xl">
      <div
        className="relative aspect-[16/9] overflow-hidden rounded-[22px] ring-1 ring-black/5 sm:rounded-[28px]"
        style={{
          background: "#c9dcf2",
          boxShadow:
      ...
      >
        {/* Menu bar */}
        <div className="flex h-7 items-center gap-3 bg-white/60 px-3.5 backdrop-blur-md sm:h-8 sm:px-4">
