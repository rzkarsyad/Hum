...
final class WordTokenTests: XCTestCase {
    ...
    func test_twoEqualWords_charWeighted() {
        // duration=2.0, effective=1.8, "Hello"(5)+"world"(5)=10
        // word[0]: 10.0+(0/10)*1.8=10.0, word[1]: 10.0+(5/10)*1.8=10.9
    ...
    func test_noNextTimestamp_uses5sFallback() {
        // duration=5.0, effective=4.5, "Hello"(5)+"world"(5)=10
        // word[0]: 10.0, word[1]: 10.0+(5/10)*4.5=12.25
        let line = LyricLine(timestamp: 10.0, text: "Hello world")
    ...
    func test_longerWordGetsMoreTime() {
        // "hi"(2)+"world"(5)=7. duration=7.0, effective=6.3
        // word[0]: 0.0+(0/7)*6.3=0.0, word[1]: 0.0+(2/7)*6.3=1.8
